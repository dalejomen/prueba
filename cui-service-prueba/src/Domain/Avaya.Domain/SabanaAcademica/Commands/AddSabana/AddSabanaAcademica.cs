...
namespace Ibero.Services.Avaya.Domain.SabanaAcademica.Commands.AddSabana
{
    public class AddSabanaAcademica : IRequest<object>
    {
        ...
        public class Handler : IRequestHandler<AddSabanaAcademica, object>
        {
            ...
            public async Task<object> Handle(AddSabanaAcademica request, CancellationToken cancellationToken)
            {
                try
                {
                ...
                {
                    throw new DeleteFailureException(nameof(AddSabanaAcademica), ex.Message, ex.Message);
                }
