...
using System.Threading.Tasks;
    ...
    public class NewZohoLeadsAndDealsCommands : IRequest<object>
    {
        ...
        public class Handler : IRequestHandler<NewZohoLeadsAndDealsCommands, object>
        {
            ...
            public async Task<object> Handle(NewZohoLeadsAndDealsCommands request, CancellationToken cancellationToken)
            {
                ...
                {
                    throw new DeleteFailureException(nameof(NewZohoLeadsAndDealsCommands), ex.Message, ex.Message);
                }
                return response;
            }
        }
